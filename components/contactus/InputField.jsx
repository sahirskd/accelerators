...
const InputField = ({ label, id, type = "text" }) => {
    return (
        <>
            <Input autocomplete="false" id={id} type={type} className="placeholder:text-transparent peer rounded-xl border-solid border-white/10 bg-[#1F1F1F] text-white h-14 px-[20px] pt-[26px] text-base w-full" placeholder="fullName" />
